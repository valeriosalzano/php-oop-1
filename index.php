...
$movie_1_genres = ['fantasy', 'avventura', 'commedia'];
$movie_2_genres = ['azione','thriller','fantascienza'];

$movie_1 = new Movie("Dungeons & Dragons - L'onore dei ladri","IT",$movie_1_genres,"2023","movie_1_poster_link", 3.5 ,$movie_1_plot);
$movie_2 = new Movie("V per Vendetta","IT",$movie_2_genres,"2006","movie_2_poster_link", 4.5, $movie_2_plot);
